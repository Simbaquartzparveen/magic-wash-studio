...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Steam Clean — Premium Mobile Car Wash & Detailing" },
      ...
      { property: "og:site_name", content: "Steam Clean" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Steam Clean — Premium Mobile Car Wash & Detailing" },
